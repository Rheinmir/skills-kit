---
name: trace
description: Evidence-driven tracing lane that orchestrates competing tracer hypotheses in Antigravity built-in team mode
agent: tracer
level: 2
---
...
Use **Antigravity built-in team mode** for `/trace`.
...
3. “Create one tracer lane per hypothesis using Antigravity built-in team mode.”
