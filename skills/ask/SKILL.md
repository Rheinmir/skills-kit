---
name: ask
description: Ask Antigravity, Codex, or Gemini via local CLI and capture a reusable artifact
---

# Ask

Use OMC's canonical advisor skill to route a prompt through the local Antigravity, Codex, or Gemini CLI and persist the result as an ask artifact.
